...
DEBUG = True
#ip.maquina.visualizador
ALLOWED_HOSTS = ["localhost", "54.174.102.22"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "34.228.12.3", #"ip.maquina.db",  # Dirección IP de la base de datos
...
MQTT_HOST = "18.215.174.233" #"ip.maquina.mqtt"
